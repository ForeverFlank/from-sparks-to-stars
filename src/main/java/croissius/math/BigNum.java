package croissius.math;

import java.math.BigDecimal;
import java.math.RoundingMode;
import java.util.Optional;

public record BigNum(double mantissa, double exponent) implements Cloneable{
    ...
    public static BigNum pow(BigNum base, BigNum exponent) {
        ...
        double finalExponent = Math.floor(expValue);
        double mantissa = Math.pow(10.0, expValue - finalExponent);
        return new BigNum(mantissa, finalExponent);
    }
